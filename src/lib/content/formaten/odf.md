...
Gebruik ODF wanneer de ontvanger het document moet kunnen bewerken. Denk aan:

- Sjablonen die ingevuld moeten worden
- Conceptdocumenten voor samenwerking
- Rapporten die anderen kunnen aanpassen
- Spreadsheets met bewerkbare gegevens

### Praktische tip: open by design

Gebruik open standaarden direct bij het maken van documenten, niet pas bij het archiveren. Direct werken in ODF-formaat voorkomt conversieproblemen achteraf, zoals verlies van informatie, opmaak of structuur.
...
- **Leveranciersonafhankelijk**: vrijwel elke tekstverwerker kan ODF-documenten openen en bewerken
...
- [DUTO-raamwerk](https://www.nationaalarchief.nl/archiveren/duto) (Nationaal Archief)
